...
export const Analytics = () => {
  ...
  const recentPosts = posts.filter((post) => new Date(post.timestamp) >= weekAgo);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                {categoryStats.map((stat, index) => (
                  ...
                  >
                    ...
                    <Badge variant="secondary">{stat.avgUpvotes.toFixed(1)} avg</Badge>
                  </div>
                ))}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Community favorites that resonated most</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {topPosts.map((post) => (
                ...
                {topPosts.length === 0 && (
                  <p className="text-center text-muted-foreground py-8">No posts available yet.</p>
                )}
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>How your voices are making a difference</CardDescription>
          </CardHeader>
          <CardContent>
